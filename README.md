...
The Online Reactable is a version on web page of a reactable, i.e., a real-time intuitive electronical musical instrument, made up of a touch screen surface, which is an interface between the user and the music production, and buttons representing oscillators, filters and effects. By shifting and chaining buttons on the surface, a sound pattern is composed, emulating the behavior of an analogue synthesizer. Parameters can be changed to obtain different kind of results. <br>
